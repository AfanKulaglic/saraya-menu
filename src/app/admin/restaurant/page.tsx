...
export default function RestaurantEditor() {
  ...
  const generalFields: { key: keyof RestaurantInfo; label: string; icon: any; placeholder: string }[] = [
    { key: "name", label: "Restaurant Name", icon: Type, placeholder: "e.g. My Restaurant" },
    { key: "tagline", label: "Tagline", icon: FileText, placeholder: "e.g. Authentic Italian Kitchen" },
  ...
  const contactFields: { key: keyof RestaurantInfo; label: string; icon: any; placeholder: string }[] = [
    { key: "address", label: "Address", icon: MapPin, placeholder: "123 Main Street, Downtown" },
    { key: "openHours", label: "Opening Hours", icon: Clock, placeholder: "10:00 AM - 11:00 PM" },
